...
print(f"DEBUG (p_09.py): Loaded epochs: {epochs}")
print(f"DEBUG (p_09.py): Loaded price_threshold: {price_threshold}")
print(f"DEBUG (p_09.py): Loaded stop_loss_pct: {stop_loss_pct}")
print(f"DEBUG (p_09.py): Loaded take_profit_pct: {take_profit_pct}")
# --- END DEBUG PRINTS ---
