...
plt.ioff() # <--- ADD THIS LINE RIGHT AFTER IMPORTING PLT
...
def backtest_strategy(df_data, initial_capital=100000, stop_loss_pct=0.01, take_profit_pct=0.02, transaction_cost_pct=0.0001):
...
plt.close('all') # <--- ADD THIS LINE TO CLOSE FIGURES IN MEMORY

# --- Print final performance with local date and time ---
